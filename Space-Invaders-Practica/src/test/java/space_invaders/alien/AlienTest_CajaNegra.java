...
public class AlienTest_CajaNegra {
    ...
    class alienConstructorTest{
        ...
        void alienCP5(){
            ...
            int posicionXEsperada = Commons.BORDER_LEFT;
            int posicionYEsperada = Commons.BOARD_HEIGHT - 1;
        ...
        void alienCP15(){
            alien = new Alien(6, -1);
            int posicionXEsperada = Commons.BORDER_LEFT + 1 ;
            int posicionYEsperada = 0;
        ...
        void alienCP29(){
            ...
            int posicionXEsperada = Commons.BOARD_WIDTH - Commons.BORDER_RIGHT - 1 ;
            int posicionYEsperada = 0;
    ...
    class alienBombTest{
        ...
        void alienBombCP1(){
            alien = new Alien(4, -1);
            bomb = alien.getBomb();
            int posicionBombXEsperada = Commons.BORDER_LEFT;
        ...
        void alienBombCP5(){
            ...
            bomb = alien.getBomb();
            int posicionBombXEsperada = Commons.BORDER_LEFT;
            int posicionBombYEsperada = Commons.BOARD_HEIGHT - 1;
        ...
        void alienBombCP15(){
            alien = new Alien(6, -1);
            bomb = alien.getBomb();
            int posicionBombXEsperada = Commons.BORDER_LEFT + 1 ;
            int posicionBombYEsperada = 0;
        ...
        void alienBombCP29(){
            alien = new Alien(327, -1);
            bomb = alien.getBomb();
            int posicionBombXEsperada = Commons.BOARD_WIDTH - Commons.BORDER_RIGHT - 1 ;
            int posicionBombYEsperada = 0;
